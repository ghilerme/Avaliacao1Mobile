...
class Activity2 : AppCompatActivity() {
    private val allFlags = listOf(
        ...
        Flag(R.drawable.flag_bhutan, "Bhutan"),
        ...
        Flag(R.drawable.flag_hungrary, "Uruguai"),
        ...
        Flag(R.drawable.flag_saint_barthelemy, "Saint Barthélemy"),
        Flag(R.drawable.flag_south_africa, "Africa do Sul"),
